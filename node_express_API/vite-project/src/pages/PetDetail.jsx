...
function PetDetail({ setPetToEdit }) {
    ...
    // passing URL parameter to the endpoint
    // also reading from the URL in the front-end app
    const getPet = async () => {
        try {
            /* FETCH */
    ...
    // once deletion is successful, redirect to the home page (root of the app)
