...
// very similar to AddPet.jsx
// here, the pet info states are initialized with the values of the pet to edit
...
function EditPet({ petToEdit }) {
    ...
    // construct an object with the user-provided data from the form
